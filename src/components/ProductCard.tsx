      ...
      <div ref={cardRef} className="bg-white rounded-lg overflow-hidden border border-[var(--border)] relative cursor-pointer transition-all hover:shadow-lg hover:border-transparent hover:-translate-y-1 group">
        ...
        <div className="relative h-[220px] bg-[var(--bg-soft)] flex items-center justify-center overflow-hidden">
          ...
          <div className="absolute bottom-[-50px] left-0 right-0 flex justify-center gap-2 p-2.5 transition-all duration-300 group-hover:bottom-2.5">
            ...
            <button onClick={handleToggleWishlist} className={`w-9 h-9 rounded-full flex items-center justify-center shadow-sm hover:scale-110 transition-all ${inWishlist ? 'bg-[var(--red)] text-white' : 'bg-white hover:bg-[var(--copper)] hover:text-white'}`} title="Wishlist">
            ...
            <button onClick={handleWhatsAppInquiry} className="w-9 h-9 rounded-full bg-white flex items-center justify-center shadow-sm hover:bg-[#25D366] hover:text-white hover:scale-110 transition-all" title="WhatsApp Inquiry">
